...
<body style="background-image: url('imgs/fundoAgendamento.jpg') ;         background-size: cover ">
    ...
    <div class="full reveal" id="incentivoDigital" data-reveal style="background-color:#2C255B;">
        <div style="display: grid;  justify-content: center; align-content: center; height: 100vh; padding-top: 0px;">
            <center style="color: white;">
                <h2>Oi. Que tal ser atendido sem sair de sua casa ou escritório?</h2>
                <h3>O Fácil possui uma agencia on line, onde suas solicitações de serviços podem ser realizadas em qualquer lugar do mundo!</h3>

                <br>
                <br>
                <a class="button" style="width: 100%; background-color:#28536b" href="https://agendafacil.guarulhos.sp.gov.br/maisDigital/" target="_self"> 
                    <h4>Clique aqui para acessar o Mais Digital</h4>
                </a>
                <br>
                <br>


                <a class="button" data-close aria-label="Close modal" style=" background-color:#28536b ;color:rgb(209, 234, 248); width: 100% ;font-weight: bold;">

                    <h4>Clique aqui para continuar o Agendamento Presencial</h4>
                </a>
                ...
                .done(function(data) {
                    ...
                    if (condicao == false) {
                        ...
                        if (data.retornoCondicao.dados[0].validaTipoCadastro == 1) {
                            ...
                            $('#incentivoDigital').foundation('open');
